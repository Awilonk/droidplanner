...
import com.playuav.android.fragments.RockerFragment2;
...
public final class DroneApi extends IDroneApi.Stub implements DroneEventsListener {
    ...
    public void arm(boolean arm) throws RemoteException {
     ...
     //  Toast.makeText(context, "LB", Toast.LENGTH_LONG).show();
     //    int[] rcOutputs = new int[8];
     //   for(int i=0;i<8;i++) {
      //      rcOutputs[i] = 1100;
      //  }
        //RockerFragment2 a = new RockerFragment2();

     //   MavLinkRC.sendRcOverrideMsg(this.droneMgr.getDrone(), RockerFragment2.rcOutputs);
    }
    ...
    //@Override
    public void dosendRcOverrideMsg( int[] rcOutputs) throws RemoteException{
        this.droneMgr.getDrone().getRC().sendRcOverrideMsg(rcOutputs);
    }
    @Override
